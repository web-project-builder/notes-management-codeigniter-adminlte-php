...
class Notes_category_model extends CI_Model {       
	...
	/**
      ...
      * @param : $id is value of notes_category_id
      */
	public function Get_data_id($id='') {
		 $this->db->select('*');
		 $this->db->from('notes_category');
		 $this->db->where('notes_category_id' , $id);
		 $query = $this->db->get();
